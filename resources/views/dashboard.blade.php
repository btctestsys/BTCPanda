			...
			<div class="col-md-3 col-lg-3">
				...
				<div class="widget-bg-color-icon card-box fadeInDown animated">
					...
					<div class="text-right">
						...
						<p class="text-muted">DSV March</p>
					</div>
					<div class="clearfix"></div>
				</div>
				</a>
...
<div class="col-md-6 col-lg-6">
	...
	<div class="col-md-6 col-lg-12">
		<div class="widget-bg-color-icon card-box">
		<h3 class="page-title">Top 20: March 2016 DSV Standing</h3>
		<hr>
Top 3 highest Direct Sales Volume (DSV) for March 2016 will receive :-<br>
1.) winner : 500 pins (Worth USD5,000.00)<br>
2.) runner up: 300 pins (Worth USD3,000.00)<br>
